...
function m5send_left() { 	liffToggleDeviceLedState(2);}
function m5send_right() {	liffToggleDeviceLedState(3);}
function m5send_backward() {	liffToggleDeviceLedState(4);}
function m5send_stop() {	liffToggleDeviceLedState(0);
function mp5_speak() {		liffToggleDeviceLedState(5);
...
function liffToggleDeviceLedState(state) {
   var item = new Uint8Array([state]) ; //グローバル変数
